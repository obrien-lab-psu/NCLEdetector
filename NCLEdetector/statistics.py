...
class FoldingPathwayStats:
    ...
    """
    A class to analyze the folding pathway statistics resulting from the Markov State Model (MSM) of folding generated by NCLEdetector.clustering.MSMNonNativeEntanglementClustering
    """
...
class MSMStats:
    ...
    """
    A class to analyze various statistical properties of the Markov State Model (MSM) of folding generated by NCLEdetector.clustering.MSMNonNativeEntanglementClustering
    """
